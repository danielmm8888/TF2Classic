...
static s_MapInfo s_Maps[] = {
	...
	"ctf_avanti",		"Avanti",			"#Gametype_AttackDefense_CTF",	"MacD11, Zorbos",
	"cp_avanti",		"Avanti",			"#Gametype_AttackDefense",		"MacD11, Zorbos",
	"ctf_landfall_rc"	"Landfall",			"#Gametype_CTF",				"Dr. Spud",
	"vip_ashworks",		"Ashworks",			"Gametype_VIP",					"Berry",
	"cp_ashworks",		"Ashworks",			"Gametype_AttackDefense",		"Berry",
	"cp_callous2",		"Callous",			"Gametype_AttackDefense",		"Berry",
	"blockfortress_a5", "Blockfortress",	"#Gametype_CTF",				"Rummy",
};
