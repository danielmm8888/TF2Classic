...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTFMainMenuOptionsPanel::CTFMainMenuOptionsPanel(vgui::Panel *parent, const char *panelName) : CTFMainMenuPanelBase(parent, panelName)
{
	SetParent(parent);
...
bool CTFMainMenuOptionsPanel::Init()
{
	BaseClass::Init();
...
void CTFMainMenuOptionsPanel::OnKeyCodeTyped(KeyCode code)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFMainMenuOptionsPanel::GatherCurrentValues()
{
	if (!m_pDescription)
		return;

	// OK
	CTFMainMenuCheckButton *pBox;
	TextEntry *pEdit;
	ComboBox *pCombo;
	CTFMainMenuScrollBar *pScroll;
	...
	while (pList)
	{
		...
		{
		case O_BOOL:
			pBox = (CTFMainMenuCheckButton *)pList->pControl;
		...
		case O_NUMBER:
			...
			break;
		case O_SLIDER:
			pScroll = (CTFMainMenuScrollBar *)pList->pControl;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFMainMenuOptionsPanel::CreateControls()
{
	DestroyControls();
	...
	while (pObj)
	{
		...
		{
		case O_BOOL:
			pBox = new CTFMainMenuCheckButton(pCtrl, "DescCheckButton", pObj->prompt);
		...
		case O_NUMBER:
			...
			break;
		case O_SLIDER:
			pScroll = new CTFMainMenuScrollBar(pCtrl, "DescScrollEntry", pObj->prompt);
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFMainMenuOptionsPanel::DestroyControls()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFMainMenuOptionsPanel::SaveValues()
{
