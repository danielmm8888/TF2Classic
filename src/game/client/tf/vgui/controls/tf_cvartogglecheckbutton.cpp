...
vgui::Panel *tf_cvartogglecheckbutton_Factory()
{
	return new CCvarToggleCheckButton( NULL, NULL, "tf_cvartogglecheckbutton", NULL );
}
DECLARE_BUILD_FACTORY_CUSTOM( CCvarToggleCheckButton, tf_cvartogglecheckbutton_Factory );

CCvarToggleCheckButton::CCvarToggleCheckButton( Panel *parent, const char *panelName, const char *text, 
	char const *cvarname )
	: CTFAdvCheckButton(parent, panelName, text)
{
