...
ConVar cam_idealyaw( "cam_idealyaw", "0", FCVAR_ARCHIVE| FCVAR_CHEAT );	 // thirdperson yaw		+ConVar cam_idealyaw( "cam_idealyaw", "0", FCVAR_ARCHIVE);	 // thirdperson yaw
ConVar cam_idealpitch( "cam_idealpitch", "0", FCVAR_ARCHIVE | FCVAR_CHEAT  );	 // thirperson pitch		+ConVar cam_idealpitch( "cam_idealpitch", "0", FCVAR_ARCHIVE);	 // thirperson pitch
ConVar cam_idealdist( "cam_idealdist", "150", FCVAR_ARCHIVE | FCVAR_CHEAT );	 // thirdperson distance		+ConVar cam_idealdist( "cam_idealdist", "150", FCVAR_ARCHIVE);	 // thirdperson distance
ConVar cam_idealdistright( "cam_idealdistright", "0", FCVAR_ARCHIVE | FCVAR_CHEAT );	 // thirdperson distance		+ConVar cam_idealdistright( "cam_idealdistright", "0", FCVAR_ARCHIVE);	 // thirdperson distance
