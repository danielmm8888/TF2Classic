...
int MeleeAllclassArmActTable[13][2] = {
	{ ACT_VM_DRAW, ACT_MELEE_ALLCLASS_VM_DRAW },
	{ ACT_VM_HOLSTER, ACT_MELEE_ALLCLASS_VM_HOLSTER },
	{ ACT_VM_IDLE, ACT_MELEE_ALLCLASS_VM_IDLE },
	{ ACT_VM_PULLBACK, ACT_MELEE_ALLCLASS_VM_PULLBACK },
	{ ACT_VM_PRIMARYATTACK, ACT_MELEE_ALLCLASS_VM_PRIMARYATTACK },
	{ ACT_VM_SECONDARYATTACK, ACT_MELEE_ALLCLASS_VM_SECONDARYATTACK },
	{ ACT_VM_RELOAD, ACT_MELEE_ALLCLASS_VM_RELOAD },
	{ ACT_VM_DRYFIRE, ACT_MELEE_ALLCLASS_VM_DRYFIRE },
	{ ACT_VM_IDLE_TO_LOWERED, ACT_MELEE_ALLCLASS_VM_IDLE_TO_LOWERED },
	{ ACT_VM_IDLE_LOWERED, ACT_MELEE_ALLCLASS_VM_IDLE_LOWERED },
	{ ACT_VM_LOWERED_TO_IDLE, ACT_MELEE_ALLCLASS_VM_LOWERED_TO_IDLE },
...
{	
	...
	switch ( iWeaponRole )
	{
		...
		case TF_WPN_TYPE_MELEE_ALLCLASS:
			for (int i = 0; i < 13; i++)
			{
				if ( MeleeAllclassArmActTable[i][0] == iActivity )
					iActivity = MeleeAllclassArmActTable[i][1];
			}
			break;
...
acttable_t CTFWeaponBase::m_acttableSecondary2[] =
{
...
// PRIMARY2 IS UNFINISHED
acttable_t CTFWeaponBase::m_acttablePrimary2[] = 
{
	{ ACT_MP_STAND_IDLE,		ACT_MP_STAND_PRIMARY,				false },
	{ ACT_MP_CROUCH_IDLE,		ACT_MP_CROUCH_PRIMARY,				false },
	{ ACT_MP_DEPLOYED,			ACT_MP_DEPLOYED_PRIMARY,			false },
...
acttable_t *CTFWeaponBase::ActivityList( int &iActivityCount )
{
	...
	case TF_WPN_TYPE_SECONDARY2:
		...
		break;
	case TF_WPN_TYPE_PRIMARY2: // PRIMARY2 IS UNFINISHED
